        		...
        		<div class="modal-content">
        			...
        			<div class="modal-body">
	                    ...
	                    <form role="form" action="" method="post" id="regisForm" class="registration-form">
                            ...
                            <div class="form-group">
                                <label class="sr-only" for="form-user-sex">性别</label>
                                <select name="loginSex" id="loginUserSex"  class="form-control"  onkeyup="this.value=this.value.replace(/\s+/g,'')">
                        ...
                        <form role="form" action="" method="post" id="loginForm" class="registration-form">
                           ...
                           <div class="form-group">
							<div class="col-sm-9 button1">
								...
								<input type="text"  style="margin-left: -14px;" name="verificationCode"  placeholder="请输入..." class="form-verification-code form-control inputcode" id="verificationCode" >
							</div>
...
function loginFun(){
    ...
    console.info("verificationCode"+verificationCode);
     if(flag){
